...
if __name__ == "__main__":
    ...
    Procedure: N-K eval for each pair of algorithms, where N is the number of agents and k is the number of unseen agents.
        - For  I in algo list: 
            ○ For j in algo list: 
                § Create log folder based on algo names, alphabetically sorted.
    ...
    Does k refer to the number of agents generated by algo i or algo j? 
        - k refers to the number of unseen agents, generated by algorithm j (2nd algo)
    '''
    # set seed 
    random.seed(0)
    EVAL_SEED = 394820
